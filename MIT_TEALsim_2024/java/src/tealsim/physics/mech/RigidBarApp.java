                                                            /* $Id: RigidBarApp.java,v 1.4 2007/08/14 20:53:25 pbailey Exp $ */
...
public class RigidBarApp extends SimWorld {
	...
	public RigidBarApp() {
		...
		((SimEngine)theEngine).setShowTime(false);
		theEngine.setDeltaTime(0.0025);
		mSEC.init();
...
//        viewer.setLookAt(new Point3d(-0.05,0.1,0.25), new Point3d(0.01,-0.05,-0.1), new Vector3d(0.,1.,0.));
        mViewer.setLookAt(new Point3d(0,0,0.5), new Point3d(0,0,0), new Vector3d(0.,1.,0.));
    }
