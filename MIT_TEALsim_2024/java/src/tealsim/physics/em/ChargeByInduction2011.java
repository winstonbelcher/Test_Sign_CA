...
public class ChargeByInduction2011 extends SimEM implements SelectListener {
    ...
    public ChargeByInduction2011() {
        ...
        node1.setGeometry(Pipe.makeGeometry(50, radius1 + thickness1 / 2., thickness1, 2.));
        ...
        node2.setGeometry(Pipe.makeGeometry(50, radius2 - thickness2 / 2., thickness2, 2.));
    ...
    private void unground() {
        ...
        ring1.setDrawn(true);
        cylinder1.setColliding(true);
        ((SimEngine)theEngine).requestReorder(cylinder1);

        for (int i = 0; i < pointCharges.length; i++) {
        	((SimEngine)theEngine).requestReorder(pointCharges[i]);
        }
