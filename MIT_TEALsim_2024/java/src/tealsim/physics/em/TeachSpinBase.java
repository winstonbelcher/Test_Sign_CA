/* $Id: TeachSpinBase.java,v 1.11 2008/06/03 15:40:10 pbailey Exp $ */
/**
...
public class TeachSpinBase extends SimEM {
	...
	protected Tuple3d cameras[] = {new Point3d(0., 0.04, 0.15), new Point3d(0., 0., 0.), new Vector3d(0., 1., 0.), new Point3d(0, 2.0, 0.),
	...
	public TeachSpinBase(int maxLines, double coilsPerRing, int debugLevel, int lod) {
		...
		try {
			...
			if (useModel) {
                Node3D bgCoil = (Node3D) new Loader3DS().getTNode3D(URLGenerator.getResource("models/1_Coil_1.3DS"));
               //bgCoil.compile();
               ...
               Node3D bgCoil2 = (Node3D) new Loader3DS().getTNode3D(URLGenerator.getResource("models/1_Coil_1.3DS"));
