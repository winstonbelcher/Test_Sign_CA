/* $Id: ChargedMetalSlab2.java,v 1.1 2007/12/19 18:51:55 jbelcher Exp $ */
...
public class ChargedMetalSlab2 extends SimWorld {
    ...
    public ChargedMetalSlab2() {
        ...
        emModel.setBoundingArea(new BoundingSphere(new Point3d(), 16));
        emModel.setDamping(0.01);
        emModel.setGravity(new Vector3d(0., 0., .0));
        //		theEngine.setShowTime(true);
        emModel.setDeltaTime(.5);
        setEngine(emModel);
    ...
    public void resetCamera() {
        mViewer.setLookAt(new Point3d(0.0, 0.0, 1. * scale), new Point3d(), new Vector3d(0., 1., 0.));
