...
import teal.physics.em.PointChargeConductingSphere;
...
public class MoveableConductingSphericalShellShielding extends SimEM {
    ...
    PointChargeConductingSphere pcharge;
    ...
    public MoveableConductingSphericalShellShielding() {
	...
	//	options.add(rad4);
        ...
        pcharge = new PointChargeConductingSphere();
