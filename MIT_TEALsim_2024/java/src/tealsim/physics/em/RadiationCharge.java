...
public class RadiationCharge extends SimEM {
    ...
    public RadiationCharge() {
        ...
        mViewer.setRefreshOnDrag(false);
        ...
        isGenerating = true;
        wave = new VectorGenerator(new Vector3d(-1, 0, 0), new Vector3d(1, 0, 0), 2, false);  //  was -20 to 20 on 5/6/2012
        wave.setScale(1.);
        //wave.setHz(0.50);
        wave.setSpeed(0.3);  //  was 0.03 on 5/6/2012
    ...
    public void resetCamera() {
        mViewer.setLookAt(new Point3d(0.0, 0.0, 5.2), new Point3d(0., 0.0, 0.), new Vector3d(0., 1., 0.));
    }
