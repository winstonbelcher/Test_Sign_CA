/* $Id: ExploringElectricField.java,v 1.2 2008/12/23 19:54:40 jbelcher Exp $ */
/**
 * @author John Belcher 
 * Revision: 1.0 $
 */
...
public class ExploringElectricField extends SimEM  {
    ...
    Node3D observerNode;
    /** A 3D node for the lego man icon. */
 ...
 // set up text area for messages to player       
        ...
        BranchGroup bg01 = max.getBranchGroup("models/man.3DS","models/maps/");
