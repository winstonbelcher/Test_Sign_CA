...
public class ChargeInMagneticFieldGame extends SimEM {
    ...
    public ChargeInMagneticFieldGame() {
        ...
        double dwidth = 1.; 
        // west wall
        addWall(new Vector3d(-10., 0., 0.), new Vector3d(0., 20, 0.), wallheight);
        //north wall
        addWall(new Vector3d(-dwidth*.5, 10., 0.), new Vector3d(20-dwidth, 0., 0.), wallheight);
        // southwall
        addWall(new Vector3d(0., -10., 0.), new Vector3d(20., 0., 0.), wallheight);
        //east wall
        addWall(new Vector3d(10., -dwidth*.5, 0.), new Vector3d(0., 20-dwidth, 0.), wallheight);
