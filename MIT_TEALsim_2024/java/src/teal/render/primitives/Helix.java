 ...
 * 
 * $Id: Helix.java,v 1.7 2007/08/17 19:38:29 jbelcher Exp $ 
 * 
 */
 ...
 */
public class Helix extends Line {
    ...
    protected TNode3D makeNode() {
        HelixNode node = new HelixNode(this);
    ...
    public void render() {
        if (mNode != null) {
            if (((renderFlags & POSITION_CHANGE) == POSITION_CHANGE)
                ...
                ((HelixNode) mNode).setFromTo(position, drawTo);
                if((renderFlags & POSITION_CHANGE) == POSITION_CHANGE){
