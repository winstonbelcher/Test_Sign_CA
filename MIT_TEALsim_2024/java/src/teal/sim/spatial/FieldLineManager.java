 ...
 * 
 * $Id: FieldLineManager.java,v 1.16 2007/08/14 20:53:23 pbailey Exp $ 
 * 
 */
...
/**
 * The FieldLineManger is a utility for managing a Colletion of FieldLines.  By adding 
...
public class FieldLineManager extends EngineObj implements HasElementManager {
    ...
    private TElementManager mElementManager;
    /**
	...
	public void setElementManager(TElementManager mgr){
	    ...
	    if(mElementManager != null){
	        if(!fLines.isEmpty()){
	            ...
	            while(it.hasNext()){
	                mElementManager.addElement(it.next(),false);
	            }
	        }
	    }
	}
	...
	public void addFieldLine(FieldLine fl) {
        ...
        */
		fLines.add(fl);
		if(mElementManager != null){
		    mElementManager.addTElement(fl,false);
		}
	}
	...
	public void removeFieldLines(Collection lines){
	 ...
	 */
	public void setFieldLines(Collection fls) {
	    if(!fLines.isEmpty()){
	 ...
	 */
	public void addFieldLines(Collection fls) {
	 ...
	 */
	public ArrayList getFieldLineArrayList() {
		return fLines;
	}
