 ...
 * 
 * $Id: ActionHandler.java,v 1.6 2007/07/16 22:04:46 pbailey Exp $
 * 
 */
...
public class ActionHandler implements ActionListener {
    ...
    TFramework theApp = null;
    Hashtable simMap = new Hashtable();
        ...
        try {
            ...
            if (simRec != null) {
                ...
                if ((simRec.methodName != null) && (simRec.methodName.length() > 0)) {
                    Method theMethod = theClass.getMethod(simRec.methodName, null);

                    target = theMethod.invoke(classObj, null);
                } else {
                    target = classObj;
                }
                if (target != null) {
