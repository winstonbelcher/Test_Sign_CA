 ...
 * 
 * $Id: Wall.java,v 1.40 2007/07/17 15:46:57 pbailey Exp $ 
 * 
 */
...
public class Wall extends EngineRendered implements HasCollisionController {
    ...
    protected ArrayList adherenceList = null;
    protected float transWall = .75f;
    ...
    public Wall(Vector3d position, Vector3d edge1, Vector3d edge2, float transWall) {
        this();
        this.position = new Vector3d(position);
        this.edge1 = new Vector3d(edge1);
        this.edge2 = new Vector3d(edge2);
