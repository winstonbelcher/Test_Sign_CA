 ...
 * 
 * $Id: Circuit.java,v 1.25 2007/12/04 20:59:14 pbailey Exp $ 
 * 
 */
...
/**
 * The teal.sim.physical.em.Circuit class represents an idealized geometry
 * electric circuit, which is defined over an infinte length cylindrical
 * shell.
 */
public class Circuit extends EMObject implements HasRadius,GeneratesE, GeneratesB, IsSpatial {
    ...
    // Component lists.
	protected ArrayList batteryList = new ArrayList(); 
	protected ArrayList resistorList = new ArrayList(); 
	protected ArrayList capacitorList = new ArrayList();
	protected ArrayList particleList = new ArrayList();
