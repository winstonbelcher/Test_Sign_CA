 ...
 * 
 * $Id: WeightedPendulumNode.java,v 1.6 2007/07/16 22:04:56 pbailey Exp $ 
 * 
 */
...
//		setGeometry(0,Cylinder.makeGeometry(24,rad,len).getIndexedGeometryArray(),0);
		...
		Geometry stem  = teal.render.geometry.Pipe.makeGeometry(20, 1., 1., 1.).getIndexedGeometryArray(true);
	...
	public void updateRingGeometry(double r1, double r2, double d) {
		Geometry stem  = teal.render.geometry.Pipe.makeGeometry(20, (r1+r2)*0.5, r2-r1, d).getIndexedGeometryArray(true);
		ringshape.setGeometry(stem);
	}
