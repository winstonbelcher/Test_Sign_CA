 ...
 * 
 * $Id: Loader3DS.java,v 1.18 2007/07/26 14:44:47 pbailey Exp $ 
 * 
 */
...
public class Loader3DS  implements teal.render.scene.TLoader
{
	...
	public Scene load(String path, String texPath) throws IOException {
		texturePath = texPath;
		return load(path);
	...
	public Scene load(DataInputStream in) throws IOException {
