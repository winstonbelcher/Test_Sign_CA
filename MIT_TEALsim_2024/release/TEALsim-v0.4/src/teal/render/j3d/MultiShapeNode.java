 ...
 * 
 * $Id: MultiShapeNode.java,v 1.13 2007/07/16 22:04:54 pbailey Exp $ 
 * 
 */
...
public class MultiShapeNode extends Node3D // implements ShapeNode3D
{
	 ...
	 */
	protected ArrayList mShapes = null;
	 ...
	 */
	public MultiShapeNode(Collection shapes){
		super();
		mShapes = new ArrayList();
	 ...
	 */
	public MultiShapeNode(TAbstractRendered element, Collection shapes){
		this(shapes);
		setElement(element,true);
	}
	 ...
	 */
	public void setAppearances(Collection appearances) {
		int k = 0;
