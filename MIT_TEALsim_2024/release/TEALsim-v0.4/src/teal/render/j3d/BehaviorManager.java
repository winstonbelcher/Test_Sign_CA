 ...
 * 
 * $Id: BehaviorManager.java,v 1.26 2007/08/17 19:38:29 jbelcher Exp $ 
 * 
 */
        ...
        */
        ...
        public void mousePressed(MouseEvent me) {
            ...
            if (button == MouseEvent.BUTTON1) {
                ...
                selectManager.noPickResult();
                if (selectManager.disableVpBehaviorWhileSelecting()) getVpBehavior().setEnable(selectManager.isSelectionEmpty());
            }
        ...
        public void transformChanged(int mode,Transform3D trans) {
            if (mode == TViewer.NONE) {
                ...
                Collection objs = selectManager.getSelected();
