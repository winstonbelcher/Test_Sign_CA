 ...
 * 
 * $Id: AbstractViewer3D.java,v 1.17 2007/07/16 22:04:57 pbailey Exp $ 
 * 
 */
...
public abstract class AbstractViewer3D extends teal.render.viewer.Viewer implements TViewer3D, HasUniverse, HasCanvas, HasPickCanvas {
    ...
    protected Vector3d lookAtPosition;
    /**the camera angle*/
   ...
   /**Indicate whether the camera direction is changeable or not*/
	...
	cameraUpAngle = new Vector3d(0, 1 ,0);
    ...
    public void setNavigationMode(int flag) {
        if ((flag != navMode) || (mBehaviorMgr == null)) {
