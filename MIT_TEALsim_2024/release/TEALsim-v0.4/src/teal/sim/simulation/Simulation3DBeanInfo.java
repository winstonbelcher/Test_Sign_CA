 ...
 * 
 * $Id: Simulation3DBeanInfo.java,v 1.2 2008/02/11 19:46:56 pbailey Exp $ 
 * 
 */
...
public class Simulation3DBeanInfo extends AbstractElementBeanInfo {
    ...
    static Class baseClass = Simulation3D.class;
    ...
    static {
        ...
        if (baseClass != null) {
            sEvents = new ArrayList(AbstractElementBeanInfo.getEventSetList());
            try {
