 ...
 * 
 * $Id: Seafloor.java,v 1.26 2007/12/04 20:59:14 pbailey Exp $ 
 * 
 */
...
public class Seafloor extends EMObject implements GeneratesB {
    ...
    Line scanLine;
    ArrayList scanLineFieldArrows = new ArrayList();
    ArrayList scanLineCompArrows = new ArrayList();
    ...
    ArrayList rightStripes = new ArrayList();
    ArrayList leftStripes = new ArrayList();

    // edge lists
    ArrayList rightEdges = new ArrayList();
    ArrayList leftEdges = new ArrayList();

    //field line lists
    ArrayList rightFieldLines = new ArrayList();
    ArrayList leftFieldLines = new ArrayList();

    ArrayList fieldlines = new ArrayList();
    ...
    public ArrayList getRightEdges() {
        return rightEdges;
    }

    public void setRightEdges(ArrayList edges) {
        rightEdges = edges;
    }
    ...
    public void addStripe(double stripeWidth) {
        ...
        ArrayList theseLines = new ArrayList();
        //FluxFieldLine fl;
        FieldLine fl;
        //RelativeFLine fl;
        int numlines = 6;
        ...
        rightFieldLines.add(theseLines);
    ...
    public class EdgeNode extends EngineRendered {
        ...
        public void printFieldLines() {
            for (int i = 0; i < rightFieldLines.size(); i++) {
                ArrayList a = ((ArrayList) rightFieldLines.get(i));
	 ...
	 */
	public void setFieldlines(ArrayList fieldlines) {
