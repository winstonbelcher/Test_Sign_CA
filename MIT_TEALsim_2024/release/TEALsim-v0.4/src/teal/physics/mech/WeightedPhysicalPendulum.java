 ...
 * 
 * $Id: WeightedPhysicalPendulum.java,v 1.8 2007/08/16 22:09:44 jbelcher Exp $ 
 * 
 */
...
public class WeightedPhysicalPendulum extends PhysicalObject {
	...
	public Vector3d getTorque() {
		...
		if (mode == FULL_SOLUTION) {
			tmag = 0.01*(rod_mass*length*0.5 + ring_mass*ring_pos)*((EMEngine)theEngine).getGravity().length()*Math.sin(theta);
		}
