 ...
 * 
 * $Id: DLICGenerator.java,v 1.9 2008/02/11 19:53:21 pbailey Exp $
 * 
 */
...
public class DLICGenerator extends AbstractElement implements ImageGenerator, ProgressEventListener {
    ...
    protected Transform3D f2c = null; //new Vec2Transform( new Vec2( 0, 0 ), 1 );
    ...
    protected Method defaultMethod = null;
    ...
    public boolean setDefaultMethod(String str) {
        ...
        try {
            defaultMethod = this.getClass().getMethod(str, null);
            status = true;
    ...
    public void generateImage() {
        if (defaultMethod != null) {
            try {
                Object obj = defaultMethod.invoke(this,  (Object[]) null);
...
//        ImageIO.WriteTIFF(test4, "test2_normalize.tif");
        ...
        case Teal.ColorMode_BRIGHTEN:
        	...
        	ScalarImage magImage = generateMagnitudeImage(1.0);
        		...
        		((Colorizer)colorizer).setFallOff(10.);  //dynamics.y/3.);
