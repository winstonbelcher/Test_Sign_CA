package tealsim.physics.examples;
	...
	public class Java3DSImport extends SimEM {
	    ...
	    public Java3DSImport() {
	        ...
	        //double scale3DS = 0.2; // Scale changed to reduce size
	        double scale3DS = 0.01; // this is an overall scale for .3DS objects
	 
	        Loader3DS max = new Loader3DS();
	    	
	        BranchGroup bg01 = 
	         max.getBranchGroup("models/Arm_Base.3DS","models/");
...
//	        //addElement(importedObject02);
	//   
	        ...
	        mViewer.setBackgroundColor(new Color(125,125,125));
	        mViewer.setFrontClipDistance(0.001);
	        mViewer.setBackClipDistance(10.0);
