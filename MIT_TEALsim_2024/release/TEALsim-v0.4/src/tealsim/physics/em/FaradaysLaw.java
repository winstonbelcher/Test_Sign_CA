/* $Id: FaradaysLaw.java,v 1.11 2008/07/17 11:21:39 jbelcher Exp $ */
...
import tealsim.physics.em.EMVideogame.Watcher;
...
public class FaradaysLaw extends SimEM {
    ...
    ControlGroup params,graphs,showCurrent;
    ...
    public FaradaysLaw() {
        ...
        Vector3d moveScale = mViewer.getMouseMoveScale();
        TDebug.println("Scale =" + moveScale);
        moveScale.x = 0.07;
        moveScale.y = 0.07;
        mViewer.setShowGizmos(false);
        mViewer.setMouseMoveScale(moveScale);
  ...
  //      params.add(score);    //added jwb 7/13/2008
        ...
        showRingCurrent.setText("Show Ring Current");
        showRingCurrent.addPropertyChangeListener("value",this);
        showCurrent = new ControlGroup();
        showCurrent.setText("Show or Hide Ring Current");
        showCurrent.add(showRingCurrent);
        addElement(showCurrent);
