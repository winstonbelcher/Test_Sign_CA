...
public class ChargesInBox extends SimEM implements SelectListener {
    ...
    public ChargesInBox() {
        ...
        // Building the world.
        emModel.setBoundingArea(new BoundingSphere(new Point3d(), 12.));
        emModel.setDamping(0.1);
        emModel.setGravity(new Vector3d(0., 0., 0.));
        emModel.setDeltaTime(0.4);
       ...
       // mViewer.setNavigationMode(TViewer.ORBIT | TViewer.VP_ZOOM);
        ...
        // west wall
        addWall(new Vector3d(-overalldim2, 0., 0.), new Vector3d(0., overalldim, 0.), wallheight);
        // north wall
        addWall(new Vector3d(0., overalldim2, 0.), new Vector3d(overalldim, 0., 0.), wallheight);
        // east wall
        addWall(new Vector3d(overalldim2, 0., 0.), new Vector3d(0., overalldim, 0.), wallheight);
        // south wall
        ...
        slider1.setValue(0.);
        slider1.setText("Exterior Charge");
...
//        params.add(ungroundButton);
    ...
    void addActions() {
        TealAction ta = new TealAction("Charges in a box", this);
    //    addAction("Help", ta);
        ...
        //addElement(but6);
        ImageButton = new JButton(new TealAction("Save DLIC to JPG", "Save DLIC to JPG", this));
        ImageButton.setFont(ImageButton.getFont().deriveFont(Font.BOLD));
        ImageButton.setBounds(40, 570, 195, 24);
