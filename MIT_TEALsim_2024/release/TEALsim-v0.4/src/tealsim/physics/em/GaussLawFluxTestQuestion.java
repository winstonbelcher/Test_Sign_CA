...
public class GaussLawFluxTestQuestion extends SimEM  {
    ...
    PropertyDouble angleGaussianSurface = new PropertyDouble();
    ...
    public GaussLawFluxTestQuestion() {
        super();
        // Hide run controls       
        mSEC.rebuildPanel(0);
        // Set debug level
        ...
        ShapeNodeGSphere.setTransparency(0.7f);
  ...
  //      addElement(GaussianSphereFlux);
    ...
    //    addElement(baseFluxMeter);
        ...
        showGaussianCylinderButton.setSelected(true);
        ...
        angleGaussianSurface.setText("Rotation Angle");
        angleGaussianSurface.setMinimum(-180.);
        angleGaussianSurface.setMaximum(180.0);
        angleGaussianSurface.setPaintTicks(true);
        angleGaussianSurface.addPropertyChangeListener("value", this);
        angleGaussianSurface.setValue(0.);
        angleGaussianSurface.setVisible(true);
        ...
        PositionOrientationControlGroup.setText("Gaussian Surface Position and Orientation");
        PositionOrientationControlGroup.add(posSlider_y);
        PositionOrientationControlGroup.add(posSlider_x);
        PositionOrientationControlGroup.add(angleGaussianSurface);
...
//	     		theFieldCylinderBottom[i][j].setDrawn(false);
   ...
   //  		theFieldCylinderSides[i][j].setDrawn(true)	;
    ...
    public void propertyChange(PropertyChangeEvent pce) {
        ...
        } else if (source == angleGaussianSurface) {
