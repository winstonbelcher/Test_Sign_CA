...
import teal.physics.em.InfiniteConductingPlane;
...
public class ImageChargeInfinitePlane extends SimEM {
    ...
    PointCharge pcharge;
    InfiniteConductingPlane conductingShell ;
    Rendered ring;
    ...
    public ImageChargeInfinitePlane() {

        super();
        super.initialize();
        title = "Positive Charge above Infinite Conducting Plane";
        setID(title);
        signFreeCharge = 1;
        Ninduced = 5;
        ...
        rad1 = new JRadioButton("Show total field of free charge + induced charges");        
        rad2 = new JRadioButton("Show Field of Free Charge ONLY");       
        rad3 = new JRadioButton("Show Field of Induced Charges ONLY");
	...
	//	options.add(rad4);
        ...
        pcharge.setPosition(new Vector3d(0, 8, 0));
        ...
        conductingShell = new InfiniteConductingPlane();
        conductingShell.setID(" ConductingSphericalShell ");
        conductingShell.setPosition(new Vector3d(0, 0, 0));
        conductingShell.setFreeChargePosition(new Vector3d(0, 8, 0));
  ...
  /*     
    ...
    */ 
        ...
        rposPCslider.setText("Radius Pt Charge");
        ...
        angPCslider.setText("Angle Pt Charge");
        ...
        radiusPCslider.setText("Radius Pt Charge");
        ...
        controls.setText("Control Position of Free Charge");
